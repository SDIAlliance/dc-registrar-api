...
class RackCreate(Model):
    ...
    def __init__(self, facility_id=None, total_available_power=5, total_available_cooling_capacity=5, number_of_pdus=2, power_redundancy=2, product_passport=None, description=None):  # noqa: E501
        ...
        :param total_available_power: The total_available_power of this RackCreate.  # noqa: E501
        :type total_available_power: float
        :param total_available_cooling_capacity: The total_available_cooling_capacity of this RackCreate.  # noqa: E501
        :type total_available_cooling_capacity: float
        :param number_of_pdus: The number_of_pdus of this RackCreate.  # noqa: E501
        :type number_of_pdus: int
        :param power_redundancy: The power_redundancy of this RackCreate.  # noqa: E501
    ...
    def from_dict(cls, dikt) -> 'RackCreate':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The RackCreate of this RackCreate.  # noqa: E501
        :rtype: RackCreate
        """
    ...
    def facility_id(self):
        """Gets the facility_id of this RackCreate.

        ID of the facility where the rack is located  # noqa: E501

        :return: The facility_id of this RackCreate.
        :rtype: str
        """
    ...
    def facility_id(self, facility_id):
        """Sets the facility_id of this RackCreate.

        ID of the facility where the rack is located  # noqa: E501

        :param facility_id: The facility_id of this RackCreate.
        :type facility_id: str
        """
    ...
    def total_available_power(self):
        """Gets the total_available_power of this RackCreate.

        Total available power in kW  # noqa: E501

        :return: The total_available_power of this RackCreate.
        :rtype: float
        """
    ...
    def total_available_power(self, total_available_power):
        """Sets the total_available_power of this RackCreate.

        Total available power in kW  # noqa: E501

        :param total_available_power: The total_available_power of this RackCreate.
        :type total_available_power: float
        """
    ...
    def total_available_cooling_capacity(self):
        """Gets the total_available_cooling_capacity of this RackCreate.

        Total available cooling capacity in kW  # noqa: E501

        :return: The total_available_cooling_capacity of this RackCreate.
        :rtype: float
        """
    ...
    def total_available_cooling_capacity(self, total_available_cooling_capacity):
        """Sets the total_available_cooling_capacity of this RackCreate.

        Total available cooling capacity in kW  # noqa: E501

        :param total_available_cooling_capacity: The total_available_cooling_capacity of this RackCreate.
        :type total_available_cooling_capacity: float
        """
    ...
    def number_of_pdus(self):
        """Gets the number_of_pdus of this RackCreate.

        Number of PDUs in the rack  # noqa: E501

        :return: The number_of_pdus of this RackCreate.
        :rtype: int
        """
    ...
    def number_of_pdus(self, number_of_pdus):
        """Sets the number_of_pdus of this RackCreate.

        Number of PDUs in the rack  # noqa: E501

        :param number_of_pdus: The number_of_pdus of this RackCreate.
        :type number_of_pdus: int
        """
    ...
    def power_redundancy(self):
        """Gets the power_redundancy of this RackCreate.

        Number of power feeds used for redundancy  # noqa: E501

        :return: The power_redundancy of this RackCreate.
        :rtype: int
        """
    ...
    def power_redundancy(self, power_redundancy):
        """Sets the power_redundancy of this RackCreate.

        Number of power feeds used for redundancy  # noqa: E501

        :param power_redundancy: The power_redundancy of this RackCreate.
        :type power_redundancy: int
        """
    ...
    def product_passport(self):
        """Gets the product_passport of this RackCreate.

        LCA product passport data  # noqa: E501

        :return: The product_passport of this RackCreate.
        :rtype: object
        """
    ...
    def product_passport(self, product_passport):
        """Sets the product_passport of this RackCreate.

        LCA product passport data  # noqa: E501

        :param product_passport: The product_passport of this RackCreate.
        :type product_passport: object
        """
