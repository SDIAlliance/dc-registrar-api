...
class MetricMappingConfiguration(Model):
    ...
    def __init__(self, input_metric_unit=None, input_metric_type=None, input_metric_name=None, measurement_interval=None, device_name=None):  # noqa: E501
        """MetricMappingConfiguration - a model defined in OpenAPI

        :param input_metric_unit: The input_metric_unit of this MetricMappingConfiguration.  # noqa: E501
        :type input_metric_unit: str
        :param input_metric_type: The input_metric_type of this MetricMappingConfiguration.  # noqa: E501
        :type input_metric_type: str
        :param input_metric_name: The input_metric_name of this MetricMappingConfiguration.  # noqa: E501
        :type input_metric_name: str
        :param measurement_interval: The measurement_interval of this MetricMappingConfiguration.  # noqa: E501
        :type measurement_interval: int
        :param device_name: The device_name of this MetricMappingConfiguration.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'MetricMappingConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The MetricMappingConfiguration of this MetricMappingConfiguration.  # noqa: E501
        :rtype: MetricMappingConfiguration
        """
        return util.deserialize_model(dikt, cls)

    @property
    def input_metric_unit(self):
        """Gets the input_metric_unit of this MetricMappingConfiguration.

        Unit of the input metric  # noqa: E501

        :return: The input_metric_unit of this MetricMappingConfiguration.
        :rtype: str
        """
    ...
    def input_metric_unit(self, input_metric_unit):
        """Sets the input_metric_unit of this MetricMappingConfiguration.

        Unit of the input metric  # noqa: E501

        :param input_metric_unit: The input_metric_unit of this MetricMappingConfiguration.
        :type input_metric_unit: str
        """
    ...
    def input_metric_type(self):
        """Gets the input_metric_type of this MetricMappingConfiguration.

        Type of metric (Gauge for current values, Counter for cumulative values)  # noqa: E501

        :return: The input_metric_type of this MetricMappingConfiguration.
        :rtype: str
        """
    ...
    def input_metric_type(self, input_metric_type):
        """Sets the input_metric_type of this MetricMappingConfiguration.

        Type of metric (Gauge for current values, Counter for cumulative values)  # noqa: E501

        :param input_metric_type: The input_metric_type of this MetricMappingConfiguration.
        :type input_metric_type: str
        """
    ...
    def input_metric_name(self):
        """Gets the input_metric_name of this MetricMappingConfiguration.

        Name of the input metric as it appears in the source system  # noqa: E501

        :return: The input_metric_name of this MetricMappingConfiguration.
        :rtype: str
        """
    ...
    def input_metric_name(self, input_metric_name):
        """Sets the input_metric_name of this MetricMappingConfiguration.

        Name of the input metric as it appears in the source system  # noqa: E501

        :param input_metric_name: The input_metric_name of this MetricMappingConfiguration.
        :type input_metric_name: str
        """
    ...
    def measurement_interval(self):
        """Gets the measurement_interval of this MetricMappingConfiguration.

        Measurement interval in seconds  # noqa: E501

        :return: The measurement_interval of this MetricMappingConfiguration.
        :rtype: int
        """
    ...
    def measurement_interval(self, measurement_interval):
        """Sets the measurement_interval of this MetricMappingConfiguration.

        Measurement interval in seconds  # noqa: E501

        :param measurement_interval: The measurement_interval of this MetricMappingConfiguration.
        :type measurement_interval: int
        """
    ...
    def device_name(self):
        """Gets the device_name of this MetricMappingConfiguration.

        Device name, only used when an array is passed to the target metric  # noqa: E501

        :return: The device_name of this MetricMappingConfiguration.
        :rtype: str
        """
    ...
    def device_name(self, device_name):
        """Sets the device_name of this MetricMappingConfiguration.

        Device name, only used when an array is passed to the target metric  # noqa: E501

        :param device_name: The device_name of this MetricMappingConfiguration.
        :type device_name: str
        """
