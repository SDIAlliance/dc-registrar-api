...
class FacilityCreate(Model):
    ...
    def __init__(self, location=None, embedded_ghg_emissions_facility=None, lifetime_facility=15, embedded_ghg_emissions_assets=None, lifetime_assets=10, cooling_fluids=None, maintenance_hours_generator=None, installed_capacity=None, grid_power_feeds=3, design_pue=1.4, tier_level=3, white_space_floors=1, total_space=None, white_space=None, description=None):  # noqa: E501
        ...
        :param tier_level: The tier_level of this FacilityCreate.  # noqa: E501
        :type tier_level: int
        :param white_space_floors: The white_space_floors of this FacilityCreate.  # noqa: E501
        :type white_space_floors: int
        :param total_space: The total_space of this FacilityCreate.  # noqa: E501
        :type total_space: float
        :param white_space: The white_space of this FacilityCreate.  # noqa: E501
        :type white_space: float
        :param description: The description of this FacilityCreate.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'FacilityCreate':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The FacilityCreate of this FacilityCreate.  # noqa: E501
        :rtype: FacilityCreate
        """
        return util.deserialize_model(dikt, cls)

    @property
    def location(self):
        """Gets the location of this FacilityCreate.


        :return: The location of this FacilityCreate.
        :rtype: Location
        """
    ...
    def location(self, location):
        """Sets the location of this FacilityCreate.


        :param location: The location of this FacilityCreate.
        :type location: Location
        """
        if location is None:
    ...
    def lifetime_facility(self):
        """Gets the lifetime_facility of this FacilityCreate.

        Expected lifetime of the facility in years  # noqa: E501

        :return: The lifetime_facility of this FacilityCreate.
        :rtype: int
        """
    ...
    def lifetime_facility(self, lifetime_facility):
        """Sets the lifetime_facility of this FacilityCreate.
    ...
    def cooling_fluids(self):
        """Gets the cooling_fluids of this FacilityCreate.


        :return: The cooling_fluids of this FacilityCreate.
    ...
    def cooling_fluids(self, cooling_fluids):
        """Sets the cooling_fluids of this FacilityCreate.


        :param cooling_fluids: The cooling_fluids of this FacilityCreate.
        :type cooling_fluids: List[FacilityCreateCoolingFluidsInner]
        """
    ...
    def maintenance_hours_generator(self):
        """Gets the maintenance_hours_generator of this FacilityCreate.

        Annual maintenance runtime hours for generators  # noqa: E501

        :return: The maintenance_hours_generator of this FacilityCreate.
        :rtype: float
        """
    ...
    def maintenance_hours_generator(self, maintenance_hours_generator):
        """Sets the maintenance_hours_generator of this FacilityCreate.

        Annual maintenance runtime hours for generators  # noqa: E501

        :param maintenance_hours_generator: The maintenance_hours_generator of this FacilityCreate.
        :type maintenance_hours_generator: float
        """
    ...
    def grid_power_feeds(self):
        """Gets the grid_power_feeds of this FacilityCreate.

        Number of physical power feeds  # noqa: E501

        :return: The grid_power_feeds of this FacilityCreate.
        :rtype: int
        """
    ...
    def grid_power_feeds(self, grid_power_feeds):
        """Sets the grid_power_feeds of this FacilityCreate.

        Number of physical power feeds  # noqa: E501

        :param grid_power_feeds: The grid_power_feeds of this FacilityCreate.
        :type grid_power_feeds: int
        """
    ...
    @property
    def design_pue(self):
        """Gets the design_pue of this FacilityCreate.

        Design Power Usage Effectiveness  # noqa: E501

        :return: The design_pue of this FacilityCreate.
        :rtype: float
        """
    ...
    def design_pue(self, design_pue):
        """Sets the design_pue of this FacilityCreate.

        Design Power Usage Effectiveness  # noqa: E501

        :param design_pue: The design_pue of this FacilityCreate.
        :type design_pue: float
        """
    ...
    @property
    def tier_level(self):
        """Gets the tier_level of this FacilityCreate.

        Certified/rated tier level  # noqa: E501

        :return: The tier_level of this FacilityCreate.
        :rtype: int
        """
    ...
    def tier_level(self, tier_level):
        """Sets the tier_level of this FacilityCreate.

        Certified/rated tier level  # noqa: E501

        :param tier_level: The tier_level of this FacilityCreate.
        :type tier_level: int
        """
    ...
    def white_space_floors(self):
        """Gets the white_space_floors of this FacilityCreate.

        Number of floors used for white space  # noqa: E501

        :return: The white_space_floors of this FacilityCreate.
        :rtype: int
        """
    ...
    def white_space_floors(self, white_space_floors):
        """Sets the white_space_floors of this FacilityCreate.

        Number of floors used for white space  # noqa: E501

        :param white_space_floors: The white_space_floors of this FacilityCreate.
        :type white_space_floors: int
        """
    ...
    def total_space(self):
        """Gets the total_space of this FacilityCreate.

        Total facility space (m2)  # noqa: E501

        :return: The total_space of this FacilityCreate.
        :rtype: float
        """
    ...
    def total_space(self, total_space):
        """Sets the total_space of this FacilityCreate.

        Total facility space (m2)  # noqa: E501

        :param total_space: The total_space of this FacilityCreate.
        :type total_space: float
        """
    ...
    def white_space(self):
        """Gets the white_space of this FacilityCreate.

        Total white space (m2)  # noqa: E501

        :return: The white_space of this FacilityCreate.
        :rtype: float
        """
    ...
    def white_space(self, white_space):
        """Sets the white_space of this FacilityCreate.

        Total white space (m2)  # noqa: E501

        :param white_space: The white_space of this FacilityCreate.
        :type white_space: float
        """
    ...
    def description(self):
        """Gets the description of this FacilityCreate.

        Textual description ob the facility for informational purposes  # noqa: E501

        :return: The description of this FacilityCreate.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this FacilityCreate.

        Textual description ob the facility for informational purposes  # noqa: E501

        :param description: The description of this FacilityCreate.
        :type description: str
        """
