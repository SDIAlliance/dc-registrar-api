...
#        """
#        server_create = {"number_of_psus":1,"rated_power":0.8008282,"installed_gpus":[{"vendor":"vendor","type":"type"},{"vendor":"vendor","type":"type"}],"storage_devices":[{"vendor":"vendor","type":"NVMe","capacity":2.302136},{"vendor":"vendor","type":"NVMe","capacity":2.302136}],"total_cpu_sockets":1,"total_installed_memory":5,"cooling_type":"air","rack_id":"rack_id","installed_fpgas":[{"vendor":"vendor","type":"type"},{"vendor":"vendor","type":"type"}],"product_passport":"{}","installed_cpus":[{"vendor":"vendor","type":"type"},{"vendor":"vendor","type":"type"}],"facility_id":"facility_id","number_of_memory_units":5}
#        headers = { 
